...
fetch(`https://api.openweathermap.org/data/2.5/weather?q=${valueToFetchWeather}&appid=${apiKey}`)
    ...
    .then(data => {
        ...
        console.log(data);
        console.log(lat, lon);
        // Create a base map centered on the location - leaflet.js
        ...
        // Add a tile layer for the cloud layer  - from openweatherapi
        ...
        // Add tile layer for precipitation   - from openweatherapi 
